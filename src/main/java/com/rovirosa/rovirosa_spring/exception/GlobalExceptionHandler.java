...
public class GlobalExceptionHandler {
        ...
        // ⚠️ Error de tipo incorrecto en parámetros (ej: pasar texto donde espera
        // número)
        ...
        // ⚠️ Error de ruta no encontrada (404)
        ...
        public ResponseEntity<ApiError> handleNotFound(org.springframework.web.servlet.NoHandlerFoundException ex,
                ...
                ApiError error = new ApiError(
                                ...
                                "Ruta no encontrada",
                                String.format("La ruta '%s' no existe o no está disponible", ex.getRequestURL()),
                                request.getDescription(false));
